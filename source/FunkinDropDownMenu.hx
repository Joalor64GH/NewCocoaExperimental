...
/*
THIS IS AN EDIT OF FunkinDropDownMenu I'VE MADE BECAUSE I'M TIRED OF IT NOT SUPPORTING SCROLLING UP/DOWN
BAH!
 ...
 * @author larsiusprime
 */
class FunkinDropDownMenu extends FlxUIGroup implements IFlxUIWidget implements IFlxUIClickable implements IHasParams
{
	...
	public var dropDirection(default, set):FunkinDropDownMenuDropDirection = Down;

	private function set_dropDirection(dropDirection):FunkinDropDownMenuDropDirection
	{
	...
	// private var _ui_control_callback:Bool->FunkinDropDownMenuCustom->Void;
	...
	public function new(X:Float = 0, Y:Float = 0, DataList:Array<StrNameLabel>, ?Callback:String->Void, ?Header:FlxUIDropDownHeader,
			?DropPanel:FlxUI9SliceSprite, ?ButtonList:Array<FlxUIButton>, ?UIControlCallback:Bool->FunkinDropDownMenu->Void)
	{
		super(X, Y);
		callback = Callback;
		header = Header;
	...
	/*public function setUIControlCallback(UIControlCallback:Bool->FunkinDropDownMenuCustom->Void):Void {
		_ui_control_callback = UIControlCallback;
	}*/
	 ...
	 * @return	The StrIDLabel array ready to be used in FunkinDropDownMenuCustom's constructor
	 */
...
/**
 * Header for a FunkinDropDownMenuCustom
 */
class FlxUIDropDownHeader extends FlxUIGroup
{
	...
	/**
	 * Creates a new dropdown header to be used in a FunkinDropDownMenuCustom.
	 *
...
enum FunkinDropDownMenuDropDirection
{
	Automatic;
	Down;
	Up;
