...
class Alphabet extends FlxSpriteGroup
{
	...
	public var menuType(default, set):String = 'Normal';
	...
	static var soundDialog:Sound = null;
	...
	override function update(elapsed:Float)
	{
		if (isMenuItem)
		{
			...
			{
				case 'centered':
					y = FlxMath.lerp(y, (scaledY * 120) + (FlxG.height * 0.5) + yAdd, 0.30);
	...
	function set_menuType(value:String):String
	{
		if (value.toLowerCase() == 'centered')
			screenCenter(X);
